...
A rendszer a következőképpen működhetne: minden előterjesztés --- akár parlamenti vagy állampolgári
--- feltöltésre kerül egy telefonos alkalmazásba, ahol mindenki kommentelhetné, támogathatná vagy
ellenezhetné az adott javaslatot. Amennyiben egy választókerületben a választók legalább \(20\%\)-a
szavazott, és ezek közül legalább \(60\%\) egy döntsére jutott, akkor az adott képviselő köteles lenne
a kialakult konszenzusnak megfelelően szavazni a parlamentben. Ugyanez vonatkozna a polgári
kezdeményezésekre is: konszenzus esetén az adott képviselő köteles lenne az adott javaslatot előterjeszteni
és támogatni. Amennyiben egy javaslattal kapcsolatban nincs egyetértés \(7\) munkanapon belül, akkor
a választott kerületi képviselő saját belátása szerint dönthet. A részvételi és döntési küszöbök
később módosíthatóak annak érdekében, hogy maximalizáljuk a társadalmi részvételt és a minőségi
törvényalkotást.
