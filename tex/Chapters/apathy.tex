...
Végól pedig, a tőzsde teljesítménye nem tekinthető a gazdaság egészségének vagy
...
Jól látható tehát, hogy se a GDP, az átlagbér, se a tőzsdei teljesítmény nem alkalmas
arra, hogy leírja egy gazdaság állapotát.  Ennek ellenére ezek a mutatók kapják a legtöbb
figyelmet a híradásokban.

\insertPic{wage_vs_prod}{0.4}{Az ábra a gazdasági teljesítmény és az órabér erős
	elválását mutatja \cite{wage_1}.  Jól látható, hogy 1973 óta a divergencia nő. 1973-2013
	között a gazdasági teljesítmény \(74.4\)\%-kal, míg az órabérek csupán \(9.2\)\%-kal
	nőttek. Ezt az átlag munkavállaló stagnáló fizetésként érzékeli.}
...
elegendőek lehetnek a hajléktalanság kialakulásához.
...
\insertPic{avg_price_per_meter}{0.45}{Az ábra \cite{housing_1} a magyarországi használt
	...
	mindenhol egyértelmű növekedés figyelhető meg, Budapest esetében figyelhető meg a
	leglátványosabb növekedés.}
